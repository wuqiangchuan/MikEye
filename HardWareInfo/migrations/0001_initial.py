    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DiskInfo', models.ManyToManyField(to='HardWareInfo.DiskInfo')),
                ('HardInfo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='HardWareInfo.HardInfo')),
            ],
        ),
        migrations.CreateModel(
            name='IDC',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UpdateTime', models.DateTimeField(auto_now=True)),
                ('Host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HardWareInfo.HostName')),
            ],
        ),
        migrations.CreateModel(
            name='NetInOut',
        ...
        migrations.AddField(
            model_name='hardinfo',
            name='HostName',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HardWareInfo.HostName'),
        ),
        migrations.AddField(
            model_name='hardinfo',
            name='IDC',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='HardWareInfo.IDC'),
        ),
        migrations.AddField(
            model_name='hardinfo',
            name='Status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='HardWareInfo.Status'),
        ),
        migrations.AddField(
            model_name='hardinfo',
            name='Type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='HardWareInfo.group'),
        ),
        migrations.AddField(
            model_name='diskinfo',
            name='Host',
